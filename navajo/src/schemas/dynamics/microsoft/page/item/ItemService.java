 ...
 * 
 */
@WebServiceClient(name = "Item_Service", targetNamespace = "urn:microsoft-dynamics-schemas/page/item", wsdlLocation = "http://localhost:7047/DynamicsNAV/WS/Page/Item")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:7047/DynamicsNAV/WS/Page/Item");
